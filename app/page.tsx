    ...
    <div className="min-h-screen bg-transparent flex flex-col selection:bg-blue-500/20 selection:text-blue-300 transition-colors relative">
      ...
      <section className="relative min-h-[92vh] sm:min-h-screen flex flex-col justify-center items-center pt-24 pb-16 sm:pt-32 sm:pb-20 border-b border-black/5 dark:border-white/10 bg-transparent">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full flex flex-col items-center text-center">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 dark:bg-white/5 backdrop-blur-md border border-white/15 text-xs font-semibold text-[#0070F3] dark:text-[#38BDF8] mb-6 shadow-2xs hover:border-[#0070F3] transition-colors"
          >
            <Sparkles className="w-3.5 h-3.5 text-[#0070F3] dark:text-[#38BDF8] animate-spin-slow" />
            <ShinyText text="EU Battery Passport Ready • UL 1974 Circular Protocol" speed={3.5} className="text-xs" />
            <span className="h-1.5 w-1.5 rounded-full bg-[#0070F3] dark:bg-[#38BDF8] animate-ping" />
            <span className="text-zinc-500 dark:text-zinc-400 font-normal">v2.6 OS</span>
          </motion.div>
          ...
          <motion.div
            ...
            className="text-4xl sm:text-6xl lg:text-7xl font-bold tracking-tight text-zinc-900 dark:text-zinc-100 max-w-4xl"
          >
            <BlurText text="Every Battery Has a" delay={60} className="inline-flex justify-center" />
            {' '}
            <span className="relative text-[#0070F3] dark:text-[#38BDF8] inline-block font-extrabold ml-1">
              Second Life.
              <span className="absolute bottom-2 left-0 right-0 h-3 bg-blue-500/20 dark:bg-blue-500/30 -z-10 rounded-sm -rotate-1" />
            </span>
          </motion.div>
          ...
          >
            <Link
              href="/demo"
              className="relative group inline-flex items-center gap-2 px-6 py-3.5 rounded-2xl bg-[#0070F3] dark:bg-[#0070F3] text-white font-semibold text-sm hover:bg-[#0058C6] dark:hover:bg-[#0058C6] shadow-sm hover:shadow-lg hover:shadow-blue-500/25 transition-all overflow-hidden"
            >
            ...
            <Link
              href="#hardware-view"
              className="inline-flex items-center gap-2 px-6 py-3.5 rounded-2xl bg-white/10 dark:bg-white/5 backdrop-blur-md text-zinc-900 dark:text-zinc-100 font-semibold text-sm hover:bg-white/20 dark:hover:bg-white/10 hover:border-white/30 border border-white/15 shadow-2xs transition-all hover:scale-[1.02]"
            >
      ...
      <section id="problem" className="py-20 bg-transparent border-b border-black/5 dark:border-white/10 transition-colors">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold text-zinc-900 dark:text-zinc-100 mt-2 tracking-tight">
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              <div>
                <div className="text-3xl font-bold font-mono text-[#0070F3] dark:text-[#38BDF8]">70–80%</div>
                <h3 className="text-base font-bold text-zinc-900 dark:text-zinc-100 mt-2">Residual Battery Capacity</h3>
                <p className="text-xs text-zinc-600 dark:text-zinc-400 mt-3 leading-relaxed">
                  EV batteries are commonly considered to reach the end of their first automotive life around <strong className="text-zinc-900 dark:text-zinc-100">70–80% State of Health (SoH)</strong>. However, this does <strong className="text-zinc-900 dark:text-zinc-100">not</strong> mean the battery is useless. Research shows that batteries at this level can still be suitable for less demanding applications such as stationary energy storage, depending on their chemistry, safety condition, and remaining performance.
                </p>
              </div>
            </SpotlightCard>
            ...
            >
              <div>
                <div className="text-2xl sm:text-3xl font-bold font-mono text-[#F59E0B] dark:text-[#FBBF24]">Billions in Potential Value</div>
                <h3 className="text-base font-bold text-zinc-900 dark:text-zinc-100 mt-2">Trapped Economic Value</h3>
                <p className="text-xs text-zinc-600 dark:text-zinc-400 mt-3 leading-relaxed">
            ...
            >
              <div>
                <div className="text-2xl sm:text-3xl font-bold font-mono text-[#6366F1] dark:text-[#818CF8]">Fragmented Data</div>
                <h3 className="text-base font-bold text-zinc-900 dark:text-zinc-100 mt-2">The Lifecycle Data Gap</h3>
                <p className="text-xs text-zinc-600 dark:text-zinc-400 mt-3 leading-relaxed">
                  Battery manufacturers, vehicle owners, fleet operators, service providers, second-life integrators, and recyclers often operate across different systems and data formats. Critical information such as <strong className="text-zinc-900 dark:text-zinc-100">State of Health, degradation history, usage conditions, chemistry, service records, and remaining useful life</strong> can therefore become difficult to verify when a battery changes hands.
                </p>
              </div>
            </SpotlightCard>
          </div>
          ...
          <div className="mt-14 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between text-zinc-600 dark:text-zinc-400 mb-3">
                    <span className="font-mono text-xs font-bold text-[#0070F3] dark:text-[#38BDF8]">{item.step}</span>
                    <div className="p-2 rounded-lg bg-white/10 dark:bg-white/5 border border-white/10 group-hover:bg-blue-500/10 group-hover:border-blue-500/30 group-hover:text-[#0070F3] dark:group-hover:text-[#38BDF8] transition-colors">
                      <StepIcon className="w-4 h-4" />
                    </div>
                  </div>
                  <h3 className="text-sm font-bold text-zinc-900 dark:text-zinc-100">{item.title}</h3>
                  <p className="text-xs text-zinc-600 dark:text-zinc-400 mt-1.5 leading-relaxed">{item.desc}</p>
                </SpotlightCard>
              );
            })}
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 flex justify-center">
            <Link
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#0070F3] dark:bg-[#0070F3] text-white text-xs font-semibold hover:bg-[#0058C6] dark:hover:bg-[#0058C6] shadow-xs transition-colors group"
            >
      ...
      <section id="portals" className="py-20 bg-transparent border-b border-black/5 dark:border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              <div>
                <div className="p-3 rounded-2xl bg-blue-500/10 text-[#0070F3] dark:text-[#38BDF8] border border-blue-500/20 w-fit mb-5 shadow-2xs">
                  <Factory className="w-6 h-6" />
                </div>
                <span className="text-[11px] font-bold uppercase tracking-wider text-[#0070F3] dark:text-[#38BDF8] bg-blue-500/10 border border-blue-500/20 px-2.5 py-1 rounded-full">
                  Portal 1
                </span>
                <h3 className="text-xl font-bold text-zinc-900 dark:text-zinc-100 mt-3">
                  Manufacturer & Fleet
                </h3>
                ...
                <ul className="mt-5 space-y-2 text-xs text-zinc-600 dark:text-zinc-400">
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="w-3.5 h-3.5 text-[#0070F3] dark:text-[#38BDF8]" />
              ...
              <div className="mt-8 pt-6 border-t border-black/10 dark:border-white/10">
                <Link
                  ...
                  className="w-full inline-flex items-center justify-center gap-2 py-3 px-4 rounded-xl bg-[#0070F3] dark:bg-[#0070F3] text-white text-xs font-bold hover:bg-[#0058C6] dark:hover:bg-[#0058C6] shadow-xs hover:shadow-sm transition-all group"
                >
                ...
                <Link
                  href="/manufacturer"
                  className="block text-center text-[11px] text-zinc-500 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-100 mt-2 transition-colors"
                >
            ...
            >
              <div>
                <div className="p-3 rounded-2xl bg-indigo-500/10 text-[#6366F1] dark:text-[#818CF8] border border-indigo-500/20 w-fit mb-5 shadow-2xs">
                  <User className="w-6 h-6" />
                </div>
                <span className="text-[11px] font-bold uppercase tracking-wider text-[#6366F1] dark:text-[#818CF8] bg-indigo-500/10 border border-indigo-500/20 px-2.5 py-1 rounded-full">
                  Portal 2
                </span>
                <h3 className="text-xl font-bold text-zinc-900 dark:text-zinc-100 mt-3">
                  Customer / Owner
                ...
                <ul className="mt-5 space-y-2 text-xs text-zinc-600 dark:text-zinc-400">
                  <li className="flex items-center gap-2">
                    <CheckCircle2 className="w-3.5 h-3.5 text-[#6366F1] dark:text-[#818CF8]" />
              ...
              <div className="mt-8 pt-6 border-t border-black/10 dark:border-white/10">
                <Link
                  href="/login/owner"
                  className="w-full inline-flex items-center justify-center gap-2 py-3 px-4 rounded-xl bg-[#6366F1] dark:bg-[#6366F1] text-white text-xs font-bold hover:bg-[#4F46E5] dark:hover:bg-[#4F46E5] shadow-xs hover:shadow-sm transition-all group"
                >
            ...
            >
              <div>
                <div className="p-3 rounded-2xl bg-sky-500/10 text-[#0284C7] dark:text-[#38BDF8] border border-sky-500/20 w-fit mb-5 shadow-2xs">
                  <RefreshCw className="w-6 h-6" />
                </div>
                <span className="text-[11px] font-bold uppercase tracking-wider text-[#0284C7] dark:text-[#38BDF8] bg-sky-500/10 border border-sky-500/20 px-2.5 py-1 rounded-full">
                  Portal 3
                </span>
                <h3 className="text-xl font-bold text-zinc-900 dark:text-zinc-100 mt-3">
                  Circularity Partner
              ...
              <div className="mt-8 pt-6 border-t border-black/10 dark:border-white/10">
                <Link
                  ...
                  className="w-full inline-flex items-center justify-center gap-2 py-3 px-4 rounded-xl bg-[#0284C7] dark:bg-[#0284C7] text-white text-xs font-bold hover:bg-[#0369A1] dark:hover:bg-[#0369A1] shadow-xs hover:shadow-sm transition-all group"
                >
      ...
      <section id="circularity" className="py-20 bg-transparent border-b border-black/5 dark:border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            >
              <span className="text-3xl font-bold font-mono text-[#0070F3] dark:text-[#38BDF8]">
                <AnimatedCounter value={14.2} decimals={1} suffix=" MWh" />
              </span>
              <p className="text-xs font-bold text-zinc-900 dark:text-zinc-100 mt-1">Second-Life Capacity</p>
              <p className="text-[11px] text-zinc-500 dark:text-zinc-400 mt-1">Active in stationary solar storage</p>
            </SpotlightCard>
            ...
            <SpotlightCard
              ...
              className="p-6 rounded-2xl bg-white/10 dark:bg-white/[0.03] border border-black/10 dark:border-white/10 backdrop-blur-md text-center shadow-2xs hover:shadow-lg transition-all cursor-pointer"
            >
              <span className="text-3xl font-bold font-mono text-[#6366F1] dark:text-[#818CF8]">
                <AnimatedCounter value={1022} decimals={0} suffix=" Tons" />
              </span>
              <p className="text-xs font-bold text-zinc-900 dark:text-zinc-100 mt-1">CO₂e Avoided</p>
              <p className="text-[11px] text-zinc-500 dark:text-zinc-400 mt-1">By extending cell useful life</p>
            </SpotlightCard>
            ...
            <SpotlightCard
              ...
              className="p-6 rounded-2xl bg-white/10 dark:bg-white/[0.03] border border-black/10 dark:border-white/10 backdrop-blur-md text-center shadow-2xs hover:shadow-lg transition-all cursor-pointer"
            >
              <span className="text-3xl font-bold font-mono text-[#F59E0B] dark:text-[#FBBF24]">
                <AnimatedCounter value={96.4} decimals={1} suffix="%" />
              </span>
              <p className="text-xs font-bold text-zinc-900 dark:text-zinc-100 mt-1">Mineral Yield</p>
              <p className="text-[11px] text-zinc-500 dark:text-zinc-400 mt-1">Li, Ni, Co reclaimed in recycling loop</p>
            </SpotlightCard>
            ...
            <SpotlightCard
              ...
              className="p-6 rounded-2xl bg-white/10 dark:bg-white/[0.03] border border-black/10 dark:border-white/10 backdrop-blur-md text-center shadow-2xs hover:shadow-lg transition-all cursor-pointer"
            >
              <span className="text-3xl font-bold font-mono text-[#0284C7] dark:text-[#38BDF8]">
                <AnimatedCounter value={100} decimals={0} suffix="%" />
              </span>
              <p className="text-xs font-bold text-zinc-900 dark:text-zinc-100 mt-1">Digital Traceability</p>
              <p className="text-[11px] text-zinc-500 dark:text-zinc-400 mt-1">EU Battery Passport 2026 ready</p>
            </SpotlightCard>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-transparent relative overflow-hidden border-t border-black/5 dark:border-white/10">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          <div className="inline-flex p-3 rounded-2xl bg-white/10 dark:bg-white/5 shadow-xs text-[#0070F3] dark:text-[#38BDF8] border border-white/10 mb-6">
            <Zap className="w-8 h-8 fill-current text-[#0070F3] dark:text-[#38BDF8] animate-bounce" />
          </div>

          <h2 className="text-3xl sm:text-5xl font-bold text-zinc-900 dark:text-zinc-100 tracking-tight">
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
            <Link
              href="/demo"
              className="relative group inline-flex items-center gap-2 px-8 py-4 rounded-2xl bg-[#0070F3] dark:bg-[#0070F3] text-white font-bold text-sm hover:bg-[#0058C6] dark:hover:bg-[#0058C6] shadow-sm hover:shadow-lg hover:shadow-blue-500/25 transition-all overflow-hidden"
            >
              <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000 ease-out" />
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 px-6 py-4 rounded-2xl bg-white/10 dark:bg-white/5 backdrop-blur-md text-zinc-900 dark:text-zinc-100 font-semibold text-sm hover:bg-white/20 dark:hover:bg-white/10 hover:border-white/30 border border-white/15 shadow-2xs transition-all hover:scale-[1.02]"
            >
