...
import { ShieldAlert, Zap, ArrowRight, Sparkles, KeyRound, Eye, EyeOff } from 'lucide-react';
    ...
    <div className="min-h-screen bg-zinc-100/80 dark:bg-black flex items-center justify-center p-4 sm:p-6 lg:p-10 relative text-zinc-900 dark:text-zinc-100 transition-colors">
      ...
      <div className="max-w-5xl w-full bg-white dark:bg-zinc-900 rounded-[36px] shadow-2xl border border-zinc-200/80 dark:border-zinc-800 p-4 sm:p-8 lg:p-10 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center relative overflow-hidden">
        ...
        <div className="lg:col-span-6 flex flex-col justify-center px-2 sm:px-4">
          ...
          <div className="mb-8">
            ...
            <p className="mt-2 text-sm text-zinc-500 dark:text-zinc-400">
              Restricted platform control center & hardware Smart Dock simulator.
            </p>
          </div>
          ...
          <form onSubmit={handleSignIn} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full mt-2 py-3.5 px-6 rounded-2xl bg-zinc-900 dark:bg-zinc-100 hover:bg-zinc-800 dark:hover:bg-zinc-200 text-white dark:text-zinc-900 text-sm font-semibold shadow-lg transition-all hover:scale-[1.01] active:scale-[0.99] flex items-center justify-center gap-2"
            >
          ...
          <div className="pt-2">
            <button
              type="button"
              onClick={() => handleSignIn()}
              className="w-full py-3 px-4 rounded-2xl bg-amber-500/10 dark:bg-amber-950/40 text-amber-600 dark:text-amber-400 text-xs font-bold border border-amber-500/20 hover:bg-amber-500/20 transition-all flex items-center justify-center gap-2 group"
            >
        ...
        <div className="lg:col-span-6 h-full flex items-center justify-center">
          <LoginHeroArtwork
            portalTitle="Restricted ReVoltX Ops"
            quote="Autonomous telemetry ingestion & hardware dock diagnostics."
            subquote="Connecting field technicians, electrochemical impedance sensors, and machine learning models."
            accentColor="#D89A24"
          />
        </div>
