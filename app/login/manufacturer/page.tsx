...
import { Factory, Zap, ArrowRight, Sparkles, Building2, Eye, EyeOff } from 'lucide-react';
    ...
    <div className="min-h-screen bg-zinc-100/80 dark:bg-black flex items-center justify-center p-4 sm:p-6 lg:p-10 relative text-zinc-900 dark:text-zinc-100 transition-colors">
      ...
      <div className="max-w-5xl w-full bg-white dark:bg-zinc-900 rounded-[36px] shadow-2xl border border-zinc-200/80 dark:border-zinc-800 p-4 sm:p-8 lg:p-10 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center relative overflow-hidden">
        ...
        <div className="lg:col-span-6 flex flex-col justify-center px-2 sm:px-4">
          ...
          <div className="mb-8">
            <Link href="/" className="inline-flex items-center gap-2.5 mb-6 group">
              <div className="h-10 w-10 rounded-2xl bg-[#0070F3] flex items-center justify-center text-white shadow-md group-hover:scale-105 transition-transform">
            ...
            <p className="mt-2 text-sm text-zinc-500 dark:text-zinc-400">
              Welcome back to your Manufacturer & Fleet Command.
            </p>
          </div>
          ...
          <form onSubmit={handleSignIn} className="space-y-4">
            ...
            <div className="relative">
              <input
                ...
                required
                className="w-full px-4 py-3.5 pr-11 rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-zinc-50/80 dark:bg-zinc-800/40 text-sm text-zinc-900 dark:text-zinc-100 placeholder-zinc-400 focus:bg-white dark:focus:bg-zinc-900 focus:outline-none focus:ring-2 focus:ring-[#0070F3] shadow-2xs transition-all"
                placeholder="Company Partner ID"
              />
              <Building2 className="absolute right-4 top-1/2 -translate-y-1/2 w-4 h-4 text-zinc-400 pointer-events-none" />
            </div>
            ...
            <button
              type="submit"
              className="w-full mt-2 py-3.5 px-6 rounded-2xl bg-[#0070F3] hover:bg-[#0058C6] text-white text-sm font-semibold shadow-lg shadow-blue-500/25 transition-all hover:scale-[1.01] active:scale-[0.99] flex items-center justify-center gap-2"
            >
              <span>Sign In</span>
          ...
          <div className="pt-2">
            <button
              type="button"
              onClick={() => handleSignIn()}
              className="w-full py-3 px-4 rounded-2xl bg-blue-500/10 dark:bg-blue-950/40 text-[#0070F3] dark:text-[#38BDF8] text-xs font-bold border border-blue-500/20 hover:bg-blue-500/20 transition-all flex items-center justify-center gap-2 group"
            >
        ...
        <div className="lg:col-span-6 h-full flex items-center justify-center">
          <LoginHeroArtwork
            portalTitle="Manufacturer & Fleet Portal"
            quote="Next-generation battery manufacturing & fleet intelligence."
            subquote="Register chemistry, mint digital passports, and monitor fleet degradation in real time."
            accentColor="#0070F3"
          />
        </div>
